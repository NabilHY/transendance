...
//   const conversationMessages = messages.filter(msg => msg.channel_id === activeConversation);
  ...
  return (
    // ! I must set the active conversation here using the channel id from params
    // ! sove the sendMessage() that you use in 2 files
    // ! fetch the conversation messages here
